  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        'marquee-reverse': { from: { transform: 'translateX(calc(-100% - var(--gap)))' }, to: { transform: 'translateX(0)' } },
        'marquee-vertical': { from: { transform: 'translateY(0)' }, to: { transform: 'translateY(calc(-100% - var(--gap)))' } },
        'marquee-vertical-reverse': { from: { transform: 'translateY(calc(-100% - var(--gap)))' }, to: { transform: 'translateY(0)' } },
