...
const sheetVariants = cva(
  'fixed z-50 gap-4 bg-background p-6 shadow-lifted transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out',
  {
    variants: {
      side: {
...
>(({ className, ...props }, ref) => (
  <SheetPrimitive.Description ref={ref} className={cn('text-[12px] text-muted-foreground', className)} {...props} />
));
